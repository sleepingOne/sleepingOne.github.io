...
public void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    {		
		...
		HttpSession session = request.getSession();//request session set as session			
		String sId =  request.getSession().getId();//slog
		String name = request.getParameter("user");//login param 		
		session.setAttribute("user", name);//set session name attribute
		...
		slogger.info(name+" User signed on, user object set");//session log
